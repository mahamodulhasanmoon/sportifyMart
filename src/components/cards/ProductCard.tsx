  ...
  return (
    ...
    <div className="relative">
      ...
      <img  className="lg:hidden h-[300px]" src={thumbnail} alt="watch" />
        ...
        <button onClick={handleCart} title={`${ stock>0 ? 'stock available':'out of stock'}`} className="top-4 right-4 absolute p-3.5 text-gray-600 hover:text-gray-500 flex justify-center items-center bg-white rounded-full">
