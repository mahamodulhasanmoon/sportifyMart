...
import { decrementQuantity, incrementQuantity, removeFromCart } from "../../redux/Features/products/productSlice.ts"
          ...
          <div className="flex gap-4 mt-4">
            ...
            <div>
              <button type="button" className="flex items-center px-2.5 py-1.5 border border-gray-300 text-gray-800 text-xs outline-none bg-transparent rounded-md">
                <svg onClick={handleDecrement} xmlns="http://www.w3.org/2000/svg" className="w-2.5 fill-current" viewBox="0 0 124 124">
                ...
                <svg onClick={handleIncrement} xmlns="http://www.w3.org/2000/svg" className="w-2.5 fill-current" viewBox="0 0 42 42">
